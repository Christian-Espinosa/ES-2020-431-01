...
##comando para ejecutar este test unicamente (Hay que estar en el directorio raiz ES-2020-431-01!!!! ) => pytest test/test_Confirmar_reserva/
...
class TestConfirmar(unittest.TestCase):
    def test_confirmar_reserva(self):
        ...
        h_obj_t=Hotels.Hotels("4", bk_dic[0], "60", "2", bk_dic[1])
        ...
        #init
        Reserva_Obj_temp= Confirmar_reserva(obj_viaje.get_vuelos(),obj_viaje.get_user(),obj_viaje.get_num_viatgers())
